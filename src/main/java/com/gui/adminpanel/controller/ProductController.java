...
public class ProductController {
	...
	@GetMapping("list")
	public ModelAndView productListPage(@RequestParam("page") Optional<Integer> page) {
		int currentPage = page.orElse(1);
		ModelAndView modelAndView = new ModelAndView("admin/product/product-list");
		modelAndView.addObject("products", productRepository.findAll(PageRequest.of(currentPage - 1, 5)));
		return modelAndView;
	}
	...
	public ModelAndView productViewPage(@PathVariable("id") Long id) {
		...
		return productListPage(Optional.of(1))
